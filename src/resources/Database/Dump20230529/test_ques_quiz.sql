...
CREATE TABLE `ques_quiz` (
  ...
  KEY `quiz_id` (`quiz_id`),
  CONSTRAINT `ques_quiz_ibfk_1` FOREIGN KEY (`question_id`) REFERENCES `question` (`question_id`),
  CONSTRAINT `ques_quiz_ibfk_2` FOREIGN KEY (`quiz_id`) REFERENCES `quiz` (`quiz_id`)
